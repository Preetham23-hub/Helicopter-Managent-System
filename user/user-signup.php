...
$success='';$reg_error='';
$firstname_empty='';$firstname_len='';
$lastname_empty='';$lastname_len='';
$middlename_empty='';$middlename_len='';
$username_empty='';$username_len='';
$email_empty='';$email_format='';$email_val='';$email_exists='';
$mobile_empty='';$mobile_len='';
$dob_empty='';
$gender_empty='';
$password_empty='';$password_len='';
$cpassword_empty='';
$password_match='';
...
if(isset($_POST['signup-submit'])){
	...
	}else if(username_exists($username,$con)){
	  ...
	  if(empty($mobile))
	     {
		  ...
		  else if(mobile_exists($mobile,$con))
		  {
			...
			if(empty($dob)){
				$dob_empty="<div class='error signup-error'> Please Enter DOB</div>";
							...
							VALUES ('$firstname','$lastname','$username','$email','$mobile','$dob','$gender','$password')";
									...
									if($res_result){
										if(mysqli_affected_rows($con)>0){
												...
												$firstname='';$middlename='';$lastname='';$username='';$email='';$mobile='';$dob='';$gender='';$password='';$cpassword='';
										}else{
			  	...
			  	$gender_format="<div class='error signup-error'>Enter Proper Gender (only Male,Female,Others)</div>";
			  }
...
<div class="header-area-full">
	<div class="container">
		<div class="header-area">
			...
			<a class="brand-title" href="http://localhost/hal/index.php">INDIAN HELICOPTER SERVICE</a>				
			
			<div class="header-menu" id="myNavbar">
				
				<a class="user-option" href="user-login.php">Login</a>
				<a class="user-option" href="user-signup.php">Signup</a>
			</div>
...
<div class="container">
	<div class="signup-area">
			...
			<h2 class="formarea-title">User Signup Form</h2>
			<?php echo $success; echo $reg_error;?>
			<?php echo $firstname_empty; echo $firstname_len;?>
			<?php echo $middlename_empty; echo $middlename_len;?>
			<?php echo $lastname_empty; echo $lastname_len;?>
			<?php echo $username_empty; echo $username_len; echo $username_exists;?>
			<?php echo $email_empty; echo $email_val; echo $email_format; echo $email_exists;?>
			<?php echo $mobile_empty; echo $mobile_len; echo $mobile_exists;?>
			<?php echo $dob_empty;?>
			<?php echo $gender_empty; echo $gender_format;?>
			<?php echo $password_empty; echo $password_len;?>
			<?php echo $cpassword_empty; echo $password_match;?>
			<form action="user-signup.php" method="POST" name="signup-form" id="signup-form" enctype="multipart/form-data">
					...
					<table class="signup-table signup-table-two">
						...
						<tr>
							<td>
								<input type="password" name="user-password" placeholder="Enter Password" class="signup-input" id="user-password" value="<?php echo $password;?>"/>
						...
						<tr>
							<td>
								<input type="password" name="user-cpassword" placeholder="Re-enter Password" class="signup-input" id="user-cpassword" value="<?php echo $cpassword;?>"/>
