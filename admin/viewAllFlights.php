...
<div class="header-area-full">
	<div class="container">
		<div class="header-area">
			...
			<a class="brand-title" href="index.php">INDIAN HELICOPTER SERVICE</a>				
					...
					<tr>
						...
						<th>Delete</th>
								...
								while($row = mysqli_fetch_array($res)) {
								    ...
								    echo "<td>
								    <a class='view-option' href='viewFlightAdmin.php?id=".$row['id']."'>View</a>
								    </td>";
								    
								    echo "<td>
								    <a class='cancel-option' href='deleteFlight.php?id=".$row['id']."'>Delete</a>
								    </td>";
								    echo "</tr>";
								}
